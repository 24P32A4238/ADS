...
print("The addition of {} and {} is {}".format(complex1, complex2, addition_result))
print("The multiplication of {} and {} is {}".format(complex1, complex2, multiplication_result))